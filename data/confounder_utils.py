...
### DATA PREPARATION ###
########################
def prepare_confounder_data(args, train, return_full_dataset=False, exclude_outliers=False):
    ...
    if train:
        ...
        splits = ["test"]
    subsets = full_dataset.get_splits(splits, train_frac=args.fraction, exclude_outliers=exclude_outliers)
    dro_subsets = [
        DRODataset(
            subsets[split],
            process_item_fn=None,
